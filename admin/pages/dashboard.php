<?php
// Get dashboard data from Node.js backend API only
$dashboardStats = makeApiCall('/admin/stats');
$recentOrders = makeApiCall('/admin/recent-orders');
$salesAnalytics = makeApiCall('/admin/sales-analytics');
...
$orders = $recentOrders['success'] ? $recentOrders['data'] : [];
$analytics = $salesAnalytics['success'] ? $salesAnalytics['data'] : ['salesData' => []];

// Handle API errors
$apiError = '';
if (!$dashboardStats['success']) {
    $apiError = 'Failed to load dashboard data. Please ensure your backend server is running.';
}
?>
