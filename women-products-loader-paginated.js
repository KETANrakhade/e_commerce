...
console.log('🔵 Women\'s products loader initialized - WITH PAGINATION');
            ...
            <div class="product-card" data-category="${categoryFilter}" onclick="goToDetail('${product._id}')">
                ...
                <div class="product-info">
                    ...
                    <div class="product-category">
                        <small>Category: ${product.category?.name || 'Women'}</small>
                    </div>
                </div>
            </div>
        `;
...
function applyFilter(filterValue) {
    ...
    loadWomensProducts(1, filterValue); // Reset to page 1 when filtering
}

// Load products when page loads
document.addEventListener('DOMContentLoaded', function() {
    console.log('📄 DOM loaded, initializing women\'s products loader...');
    ...
    setTimeout(() => {
        console.log('🚀 Starting women\'s product load...');
